...
\input{02_estado_tecnica/00_trends_humanoid_robotics}
...
\begin{figure}[!hbt]
\centering
\subfigure[]{\includegraphics[scale=0.4]{pie.png}}
\subfigure[]{\includegraphics[scale=0.4]{pieYOZ.png}}
